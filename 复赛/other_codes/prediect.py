...
testDir = "../data/xuelang_round2_test_b_201808031"
...
#    else:
#        yList.append(0)
modelA = load_model("./cut320-18-0.8471.h5")
modelB = load_model("./resize600-17-0.8736.h5")
...
predictDf.to_csv(("submit_"+datetime.datetime.now().strftime('%Y%m%d_%H%M%S') + ".csv"), index=False,sep=',')
print('done')
