# -*- coding: utf-8 -*-
"""
Created on Sat Jun 23 15:36:35 2018
...
# 载入模型
model = load_model('./Xception_models/model.hdf5')
...
checkpointer_1=ModelCheckpoint(filepath='Xception_models_1/model.hdf5', monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='auto', period=1)
checkpointer=ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=2, verbose=0, mode='auto', epsilon=0.0001, cooldown=0, min_lr=0.00001)
