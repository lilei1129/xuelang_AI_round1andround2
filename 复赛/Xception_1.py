...
# 载入模型
model = load_model('./Xception_models_1/cut512-16-0.8252.h5')
...
filepath=r"./Xception_models_2/cut512-{epoch:02d}-{val_acc:.4f}.h5"
...
model.fit_generator(
        ...
        class_weight=None,callbacks=[checkpointer,checkpointer_1,history],workers=4,shuffle=True)
#绘制acc-loss曲线
