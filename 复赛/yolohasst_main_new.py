...
#gen_cut_step(rawDir+'/train',320, 320, 320,0.09,0.98, cutDir+'/train')
#gen_cut_step(rawDir+'/valic',320, 320, 320,0.09,0.97, cutDir+'/valic')
#
#
...
#gen_resize(rawDir+'/train', (600,800), resizeDir+'/train')
...
print(trainGen600.class_indices)
print(valicGen600.class_indices)
